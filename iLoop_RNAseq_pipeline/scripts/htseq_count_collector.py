...
parser = argparse.ArgumentParser(description='This script will collect the counts generated by htseq-count. Outputs 2 files: one for read counts and one for stats.')
